...
data class UserPageState (
    ...
    val cemModeResultResponse: ResponseState = ResponseState.Idle,
    ...
    val cemModeResultAvailable: Boolean = false,
    ...
    val cemModeResult: Int = 0,
    val cemModeCorrect: Int = 0,
    val cemModeTotal: Int = 0,
