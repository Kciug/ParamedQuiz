...
fun TranslationModeTrialFinishedPanel(
    ...
    Surface(
        ...
        Column(
            ...
            TextTitle(
                text = stringResource(R.string.trial_finished_translation_title),
            ...
            TextPrimary(
                text = stringResource(R.string.trial_finished_translation_desc),
                textAlign = TextAlign.Center
            )
            ...
            AnimatedContent(
                ...
                label = "TranslationModeTrialPendingTransition"
            ) { pending ->
                if (pending) {
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        ButtonPrimary(
                            modifier = Modifier.testTag(TestTags.TRANSLATION_TRIAL_BUY_BUTTON),
